...
class WorkingHourSystemPage extends StatelessWidget {
  final ITTDCameraService? _cameraService = TTDServiceLocator().get<ITTDCameraService>();
  late WorkingHourSystemPageViewModel workingHourSystemPageViewModel;
  late ITTDSettingsRepository? _ittdSettingsRepository = TTDServiceLocator().get<ITTDSettingsRepository>();

  @override
  Widget build(BuildContext context) {
    workingHourSystemPageViewModel = Get.put(WorkingHourSystemPageViewModel());
    return MaterialApp(
            ...
            children: [
              ...
              ElevatedButton(
                 ...
                 workingHourSystemPageViewModel.startWork("A1");
                  if (_cameraService != null) {
                    ...
                    if (id != null) {
                      ...
                      workingHourSystemPageViewModel.startWork(id);
                    } else {
                ...
                child: Container(
                  ...
                  child: Text(
                    'Vardiyaya Başlamak İçin Qr Kodu Okutunuz',
                    style: TextStyle(
                        color: Colors.white,
                        fontSize: 18,

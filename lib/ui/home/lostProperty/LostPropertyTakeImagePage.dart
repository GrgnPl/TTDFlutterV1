...
class LostPropertyTakeImagePage extends StatelessWidget {
  final String propertyID;
  final picker = ImagePicker();
  final viewModel = Get.put(LostPropertyTakeImagePageViewModel());

  LostPropertyTakeImagePage({required this.propertyID});
            ...
            children: [
              ...
              ElevatedButton(
                ...
                child: Container(
                  ...
                  child: Text(
                    'Kayıp Eşyanın Fotoğrafını Çekiniz',
                    style: TextStyle(
                      color: Colors.white,
                      fontSize: 12,
  ...
  Future<void> onImageButtonPressed(ImageSource source) async {
    try {
      ...
      if (pickedFile != null && pickedFile.path != null) {
        ...
        if (propertyID != null) {
          await viewModel.uploadImage(propertyID,file);
        } else {
